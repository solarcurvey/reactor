...
Study public launchpad UX hierarchy only. No proprietary copy, assets, logos, or exact text. No Marvel / Iron Man / Stark branding. Do not name the product “Arc Reactor”. Founder-locked brand is **Direction C — Industrial Forge**: slag `#12110F`, steel, heat `#FF6B2B`, vessel mark. Handbook: [`docs/brand.md`](docs/brand.md) (Refs #55).
