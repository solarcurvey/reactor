...
assert(!/kms:Sign/.test(main.slice(main.indexOf('resource "aws_iam_role_policy" "github_deploy"')), "GitHub deploy role cannot sign with KMS");
assert(!/iam:PassRole/.test(main.slice(main.indexOf('resource "aws_iam_role_policy" "github_deploy"')), "GitHub deploy role cannot pass runtime roles");
assert(!/lambda:UpdateFunctionConfiguration/.test(main.slice(main.indexOf('resource "aws_iam_role_policy" "github_deploy"')), "GitHub deploy role cannot alter runtime configuration");
