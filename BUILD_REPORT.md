...
| Review shots | **Not regenerated.** Phase testids are `sr-only`. #35 stays open until post-merge. `ci-ok` requires `e2e-release-gate` **and** `web-qa` **and** `page-budget`. **Refs #35 / Refs #15 only.** |
