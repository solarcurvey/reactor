...
| Rebase | Onto `origin/main` `ad7b457` (#49 UI QA after #42). Docs/#49 conflicts kept both sides (`text-zinc-400` on `/ops` sanctions card). Sanctions AC + generation restart replayed. |
