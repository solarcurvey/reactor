...
| Rebase | Onto `origin/main` `2002aed` after squash-merged **#68**. Same PR **#75** / same branch. Official #61/#63/#62 plugins are on `main`. Indexer uses canonical `operator-policy.ts`; bind is the #65 test/fixture adapter. |
