...
| Tests | Local verify: `pnpm test:lib` green; `pnpm test:restricted` **7/7**; `pnpm test:web-security` **13/13** (2 XSS + 11 production restricted-prod: fail-closed, ignored LOCAL flags, desktop+390 wallet/geo/stale/allow, #62 write-gate bypass); `pnpm test:web:qa` **131/131**. Production four-state AC closed on this PR. |
