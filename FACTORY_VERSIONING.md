...
This is **not** the REACTOR protocol semver. Protocol release lives in `docs/version.json` (currently **0.3.3**). Factory **V1 stays V1 forever** even when the protocol release moves. See `/docs/versioning`.
