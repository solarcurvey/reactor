...
export function TokenCard({ t }: { t: LaunchToken }) {
  return (
    <Link href={launchPath(t)}>
      <Card className="group p-4 transition hover:border-rx-heat/40">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="grid h-11 w-11 place-items-center overflow-hidden rounded-[var(--rx-radius-chip)] border border-rx-steel bg-rx-slag text-xs text-rx-paper">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          <span className="rounded-[var(--rx-radius-chip)] border border-rx-steel bg-rx-steel/40 px-2 py-0.5 text-[11px] uppercase tracking-wider text-rx-paper">
