...
import { DOCS, headings, loadDoc } from "@/lib/docs";
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[1fr_180px]">
      <article>
        ...
        <p className="mt-10 text-[11px] text-zinc-600">Not audited. No public mainnet. Constants must match ReactorConstants.</p>
      </article>
