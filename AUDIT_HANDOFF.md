...
**This amendment (Industrial Forge brand, Refs #55):** founder-locked Direction C is the production visual identity — tokens, vessel mark, wordmark, favicon/OG/app icons, product chrome, and voice. #55 stays open for independent audit. Issue #36 is closed (`ad7b457`, post-merge `34729758795`); `web-qa` remains required and must cover this approved-C state (do not weaken that gate). No contract, fee, Factory, CORE, or routing change. See `/docs/brand`.
