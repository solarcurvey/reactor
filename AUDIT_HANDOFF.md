...
**This software has not been audited.** Treat every contract as hostile-unreviewed. Do not deploy to Arc Mainnet (5042). Isolated `SAFE_GENESIS` constructors are live on 5042002: Guardian `0xc04ceecDC38e73c52aB6c3Cdc6552Be089d3a934` (`guardian()` = Davis EOA `0x4583F9b7a06aB8B5b7B4A7dD27e774356015d406`), Factory `0x94a6DBEB77E346BA7c7532DA01c11DB14A3b95CA`. HW genesis is not done (`launchesPaused=true`; on-chain launch/pricing still = keeper). No Instant/Fair smoke. `claimedProdPath` stays false. The 2026-09-12 Factory `0xB48D1B397834eBcccb8961041d827487097e0535` / Guardian `0x2CdF37541256749E5CF6ac5C806e0d23A685F224` is **SUPERSEDED**. Keep #16 open.

**This amendment (PR #52 record live isolated constructors):** Draft #52 fills `deployments/arc-testnet-isolated.json` with the ops-box constructor addresses and [first](https://testnet.arcscan.app/tx/0x7955fda2d6a590d83e188daa509a7112ddb70bc126e325a5bd644761d0921e27)/[last](https://testnet.arcscan.app/tx/0x051641005b9193f512cbf30d600f1e24b6ab038daac6b19015e8cd7b5de71ee5) create txs. Davis still HW-signs `SafeGenesisBatch` (`pauseLaunches(false)` LAST). No invented Instant/Fair hashes. Factory V1 economics unchanged. No 5042.
