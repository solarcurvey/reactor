...
**This amendment (Industrial Forge brand, Refs #55):** founder-locked Direction C is the production visual identity — tokens, vessel mark, wordmark, favicon/OG/app icons, product chrome, and voice. #55 stays open for independent audit. #36 `web-qa` baselines must cover this approved state (do not weaken that gate). No contract, fee, Factory, CORE, or routing change. See `/docs/brand`.
