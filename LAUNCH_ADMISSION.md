...
| Route | Who |
| --- | --- |
| `POST /launch/admit` | Public + partner (`x-partner-key`) — decision only. JSON **16KiB** stream cap (chunked included). |
| `POST /launch/authorize` | Public — admission then isolated sign. Same **16KiB** JSON cap. |
