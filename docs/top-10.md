...
- 12-minute VWAP on indexed official trades. Nested quotes walk ValuationService ancestry (CAT → ZCAT → ZEC → USD). External spots do not control the official mark unless they are an accepted, fresh `external_price_marks` leaf.
