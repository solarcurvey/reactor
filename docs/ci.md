...
| #65 (PR #75) | Restricted-access UX + #62 write-gate e2e | Full-only step on `web-production-security`: `pnpm test:restricted` then `pnpm test:web-security`. Do not add a second workflow. **#65 stays open.** |
