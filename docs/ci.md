...
| #14 (PR #48) | GitBook handbook | Draft. Known AC gaps remain (body search, broken-link CI, visual/code-copy, version badge matrix). Cheap handbook units stay in `test:lib`. Do **not** restore `docs-sync.yml`. |
