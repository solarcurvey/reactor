...
Shared offchain gate on REACTOR-operated write/authorization HTTP. Fail closed. Browser flags are not authority. Does not block public contracts. Address screen binds merged #66 `indexerSanctionsStore().screen`. Trusted geo binds merged #67 `evaluateRequestGeo`. Issue **#62 closed** after #68 `2002aed` / [`34733128955`](https://github.com/solarcurvey/reactor/actions/runs/34733128955). Parent **#60** stays open.
