/**
 * CRE HTTP-trigger courier body. Shared by official `main.ts` and the local
 * simulator. Fetches a pre-signed MaintenanceJob and encodes typed delivery
 * bytes. Never rebuilds hops, minOut, amount, or Top-10 targets.
 */
