...
UI QA gate (issue #36 **closed** after #49) plus indexed read-path / page-budget (issue #37 **closed** after #50) and full GitHub CI extras (#17 product-merged via #42; accepted `11fdadb` / `34727535121` then `80d3cac` / `34727638255`; **#17 stays open** until this docs PR merges + post-merge docs/CI). Exact official-list OFAC screening (issue #61 **closed** after #66 `d08aa1c` / `34731099571`). Trusted geo (issue #63 **closed** after #67 `e712617` / `34731788819`, founder closed after post-merge verify). Operator policy gate (issue #62 **closed** after #68 `2002aed` / `34733128955`). Parent **#60** and **#64 / #65 / #69** stay open. Public launchpad treats token metadata as untrusted (#41 / #47). Top-10 ranks move to the canonical indexer ValuationService (issue #10 / PR #33). Tokenomics **unchanged**. Factory **V1**. No mainnet.
