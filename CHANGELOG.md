...
- Visible #37 page-budget GitHub job absorbed as a **fast** job in #73’s `.github/workflows/ci.yml` (every PR, including drafts; no feature-branch `push` pair). File stays in `pnpm test:lib`.
