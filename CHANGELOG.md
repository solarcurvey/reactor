...
Discover/search is indexer-backed (`GET /markets` q + board + cursor; issue #40) on branded main `4915f3e` after squash-merged **#80** Industrial Forge / **#81** docs-only CI path filter / **#46** observability and **#75** restricted-access UX (on **#44** `b190e86` / **#70** / **#79** / **#68**). **#35 is closed** after merged #44 + green post-merge main verification. UI QA gate (issue #36 **closed** after #49) plus indexed read-path / page-budget (issue #37 **closed** after #50) and full GitHub CI extras (#17 product-merged via #42; **#17 stays open** until post-merge docs/CI after #79). Exact official-list OFAC screening (issue #61 **closed** after #66). Trusted geo core accepted on #67; **#63 / #65** stay open through #75 post-merge verify. Operator policy gate (issue #62 **closed** after #68). Sanctions freshness (issue **#64 stays open** after #70). **#39 is reopened** after merged #46 (remaining gate: live configured telemetry-provider proof; in-process `vendor-proof` does not close it). Parent **#60** / **#15** / **#40** stay open. **#40 cannot close while #39 remains open.** **#55 stays open** after merged #80. Public launchpad treats token metadata as untrusted (#41 / #47). Tokenomics **unchanged**. Factory **V1**. No mainnet.

### Added / Changed

- Discover/search uses `useMarketsInfinite` → `GET /markets?q=&board=&cursor_*`. Chip predicates are indexer SQL (`parseBoard` / `listMarkets`). Schema **v12** adds quote-side `liquidity_usd6` and `change_24h_bps` (empty 24h % is `—`). `filterMarkets` is not in the web app. Visual hash gate is `docs/visual-accept.json`. **Refs #40.** Does not close #40, #15, or #39.
